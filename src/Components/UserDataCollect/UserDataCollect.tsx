...
const UserDataCollect = () => {
  ...
  const [educationData, setEducationData] = useState({
    ...
    educationDesc: {
      eDescription1:
        "Education Description are Shown here , with Bullet Points",
    },
  });
  ...
  const handleProjectClick = (e) => {
    ...
    let i = projectCount;
    ++i;
    const template: ReactElement<any, any> = (
      <>
    ...
    let arr: ReactElement<any, any>[] = projArrTemplate;
    arr.push(template);
    setProjArrTemplate(arr as any);
    setProjectCount(i);
  };
  ...
  const handleEducationClick = (e) => {
    ...
    let arr: ReactElement<any, any>[] = educationArrTemplate;
    arr.push(template as any);
    setEducationArrTemplate(arr as any);
    setEducationCount(i);
  };
  ...
  const handleWorkClick = (e) => {
    ...
    let arr: ReactElement<any, any>[] = workArrTemplate;
    arr.push(template);
    setWorkArrTemplate(arr as any);
    setWorkCount(i);
  };
